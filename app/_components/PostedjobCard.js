...
function PostedjobCard({ postedJob, onDelete }) {
  ...
  return (
    <li className="mb-6">
      <div className="bg-primary-900 rounded-2xl p-5 flex gap-6 items-start shadow-md shadow-accent-800">
        {/* Job image */}
        ...
        <div className="flex-1 space-y-2">
          ...
          <p className="text-lg text-primary-200">{postedJob.companyName}</p>
          ...
          <p className="text-sm text-primary-300">{postedJob.description}</p>
        </div>
